...
//  T data;
//
//  BaseResp(this.resultCode, this.resultMessage, this.data);
//
//  @override
//  String toString() {
//    StringBuffer sb = new StringBuffer('{');
//    sb.write("\"resultCode\":\"$resultCode\"");
//    sb.write(",\"resultMessage\":\"$resultMessage\"");
//    sb.write(",\"data\":\"$data\"");
//    sb.write('}');
//    return sb.toString();
//  }
...
//  Response response;
//
//  BaseRespR(this.resultCode, this.resultMessage, this.data, this.response);
//
//  @override
//  String toString() {
//    StringBuffer sb = new StringBuffer('{');
...
//
//  /// BaseResp [String status]字段 key, 默认：status.
//  String _statusKey = "resultCode";
//
//  /// BaseResp [int code]字段 key, 默认：errorCode.
////  String _codeKey = "errorCode";
//
//  /// BaseResp [String msg]字段 key, 默认：errorMsg.
//  String _msgKey = "resultMessage";
//
//  /// BaseResp [T data]字段 key, 默认：data.
...
//    _statusKey = config.resultCode ?? _statusKey;
////    _codeKey = config.code ?? _codeKey;
//    _msgKey = config.resultMessage ?? _msgKey;
